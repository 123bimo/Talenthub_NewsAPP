<footer class="w-full shadow m-2 mt-auto">
    <div class="w-full max-w-screen-xl mx-auto p-2 md:py-4">
        <div class="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0 md:space-x-2 rtl:space-x-reverse">
            <div class="flex items-center space-x-2 rtl:space-x-reverse">
                <a href="{{ url('/') }}" class="flex items-center space-x-2 rtl:space-x-reverse">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/0/0f/Boise_State_Athletic_%22B%22.png" class="h-8" alt="Flowbite Logo" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Berita.HU</span>
                </a>
            </div>
        ...
        <span class="block text-xs text-gray-500 text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline">Berita.HU</a>. All Rights Reserved.</span>
    </div>
</footer>
