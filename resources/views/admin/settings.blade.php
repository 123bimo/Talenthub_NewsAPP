...
@section('content')
    <div class="flex justify-between items-start mb-4">
        ...
        <div class="flex items-center">
            ...
            <!-- Tombol Batal -->
            <button id="cancelButton" class="hiddenflex items-center text-red-500 bg-transparent hover:text-red-900 hover:bg-red-300 border border-red-400 p-2 rounded-full">
                ...
                <div class="flex flex-col items-center justify-center mb-4">
                    <div>
                        @if(Auth::user()->profile_photo)
                            <img src="{{ Storage::url(Auth::user()->profile_photo) }}" alt="{{ Auth::user()->name }}" class="w-[200px] mt-2 object-cover rounded-full">
                        @endif
                        @error('name')
